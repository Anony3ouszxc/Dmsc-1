...
$asset = AssetCollection::make(function ($asset)
    {
        ...
        $asset->add('style', array('path' => 'assets/css/font-awesome.min.css'))
              ...
              ->add('style', array('path' => "assets/cms/fonts/kanit/font.css"))
              ...
              ->add('style', array('path' => "assets/cms/styles/scrolling-nav.css"))
      ...
      ->add('script', array('path' => 'assets/cms/js/jquery.easing.min.js'))
      ->add('script', array('path' => 'assets/cms/js/scrolling-nav.js'))
      ->add('script', array('path' => 'assets/js/frontend.min.js'));
        return $asset;
    });
?>
      ...
      <div class="app" id="app">
        <div id="content" class="app-content box-shadow-z0" role="main">
          ...
          //  echo '<div ui-view class="app-body" id="view">';
            echo '<div class="app-body" id="view">';
            echo $yield;
            echo '</div>';
            $asset->dump('script');
