...
textEditor='<textarea ui-jp="summernote" ui-options="'+d+'" class="form-control" rows="4" name="'+a+'[content][]"></textarea>';deleteRow='<i class="material-icons md-24 text-danger delete-layout"></i>';
...
},saveMapMenu:function(){var a=this;var b=$("select,input").filter(function(){return $(this).attr("data-default")!=$(this).val();});if(b.length){params=b.serializeArray();
